...
test_cases = [
    ...
    #     [
    #         MagicToken(
    #             name="Mask", colors={"W"}, types={"Enchantment"}, subtypes={"Aura"}
    #         )
    #     ],
    # ),
    # (
    ...
    #     ],
    # ),
    # ("Niko Aris", [MagicToken(predefined="Shard"), MagicToken(predefined="Shard")]),
...
def test_tokens(mtgjsondata, extractor, name, expected):
    ...
    expected_tokens = [MagicToken(**data) for data in expected]
